        ...
        children: [
          {
            ...
            icon: 'account',
            hideSideNav: true,
            viewUrl: 'https://izqalan.github.io/',
            loadingIndicator: {
              enabled: false
            },
          },
...
function myTranslationProvider() {
  var dict = {
    'de-DE': { PRODUCTS: 'Produkte', 'ORDERHISTORY': 'Bestellungen', PORTFOLIO: 'Portefeuille' },
    'en-US': { PRODUCTS: 'Products', 'ORDERHISTORY': 'Order History', PORTFOLIO: 'Porfolio' }
  };
  return {
